					...
					<div class="container " id="Modalidades">
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12"  >
								...
								<!--100 METROS FEMENINO-->
								<h1 class="mt-5 text-black text-center rounded-pill ftextoh1">RESULTADOS ESO</h1>
								...
								<div>
									<table class="table table table-hover " data-name="cienmf" border="1">
										...
										<xsl:for-each select="Alumnos/Alumno[sexo='F' and (curso='4 ESO')]">					
								...
								<div>
									<table class="table table table-hover" data-name="cmm" border="1">
										...
										<xsl:for-each select="Alumnos/Alumno[sexo='M' and (curso='4 ESO')]">
								...
								<div  >
									<table class="table table table-hover mytable" data-name="mildf" border="1">
										...
										<xsl:for-each select="Alumnos/Alumno[sexo='F' and (curso='4 ESO')]">
										<xsl:sort select="pruebas/prueba[nom_prueba='Carrera de 1200 metros Femenino']/eliminatorias/eliminatoria[nom_eli='final']/posicion" data-type="number" order="ascending" />
								...
								<div class="mt-2 rounded-pill  bg-warning buscador " >&#160;<h5 class="d-inline "> Buscar </h5>
									<input class="mt-2" type="text" id="sfm" onkeyup="myFunction('table[data-name=salf]','sfm')" placeholder="Nombre Apellido" title="Type in a name"/>&#160;
									<i class="fa-solid fa-magnifying-glass"></i>
									<a class="btn btn-primary btn-sm d-inline me-md-3 mt-2" style="float: right; height:2rem;" href="#Modalidades" role="button">
									Inicio  <i class="fas fa-arrow-up"></i>
									</a>
								...
								<h3 class="mt-2 text-center rounded-pill  ftexto ftextoh3">Cuartos de final</h3>
								<div >
									<table class="table table table-hover " data-name="salf" border="1">
										<tr class="columnas text-light">
											<th>Nombre/Apellido</th>
											<th>Posicion</th>
											<th>Marca</th>
								...
								<div class="mt-2 rounded-pill  bg-warning buscador " >&#160;<h5 class="d-inline "> Buscar </h5>
									<input class="mt-2" type="text" id="salm" onkeyup="myFunction('table[data-name=salm]','salm')" placeholder="Nombre Apellido" title="Type in a name"/>&#160;
									<i class="fa-solid fa-magnifying-glass"></i>
